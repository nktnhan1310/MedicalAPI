...
namespace Medical.Models.AutoMapper
{
    public class MedicalAutoMapper : Profile
    {
        public MedicalAutoMapper()
        {
            ...
            CreateMap<ExaminationFormAdditionServiceDetailMappingModel, ExaminationFormAdditionServiceDetailMappings>().ReverseMap();
            CreateMap<PagedList<ExaminationFormAdditionServiceDetailMappingModel>, PagedList<ExaminationFormAdditionServiceDetailMappings>>().ReverseMap();

            CreateMap<UserAllergyDetailModel, UserAllergyDetails>().ReverseMap();
            CreateMap<PagedList<UserAllergyDetailModel>, PagedList<UserAllergyDetails>>().ReverseMap();

            CreateMap<AllergyDescriptionTypeModel, AllergyDescriptionTypes>().ReverseMap();
            CreateMap<PagedList<AllergyDescriptionTypeModel>, PagedList<AllergyDescriptionTypes>>().ReverseMap();

            CreateMap<AppPolicyModel, AppPolicies>().ReverseMap();
            CreateMap<PagedList<AppPolicyModel>, PagedList<AppPolicies>>().ReverseMap();

            CreateMap<AppPolicyDetailModel, AppPolicyDetails>().ReverseMap();
            CreateMap<PagedList<AppPolicyDetailModel>, PagedList<AppPolicyDetails>>().ReverseMap();
            ...
            CreateMap<PagedList<ExaminationScheduleDetailModel>, PagedList<ExaminationScheduleDetails>>().ReverseMap();
            ...
            CreateMap<AdditionServiceDetailModel, AdditionServiceDetails>().ReverseMap();
            CreateMap<PagedList<AdditionServiceDetailModel>, PagedList<AdditionServiceDetails>>().ReverseMap();
