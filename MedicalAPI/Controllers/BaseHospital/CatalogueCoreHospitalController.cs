...
namespace MedicalAPI.Controllers.BaseHospital
{
    [ApiController]
    public abstract class CatalogueCoreHospitalController<E, T, DomainSearch> : CoreHospitalController<E, T, DomainSearch> where E : MedicalCatalogueAppDomainHospital where T : MedicalCatalogueAppDomainHospitalModel where DomainSearch : BaseHospitalSearch
    {
