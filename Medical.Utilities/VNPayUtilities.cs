...
namespace Medical.Utilities
{
    public class VNPayUtilities
    {
        ...
        /// <returns></returns>
        public static string GetIpAddress(IHttpContextAccessor _accessor)
        {
            string ipAddress;
            try
            {
        ...
        /// <summary>
        /// Trả ra message lỗi của thanh cập nhật kết quả thanh toán qua ipn
        /// </summary>
        /// <param name="status"></param>
        /// <returns></returns>
        public static string GetIPNStatusMessage(string status)
        {
            switch (status)
            {
